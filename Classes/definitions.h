...
// Block Shot
#define BLOCK_COLLISION_MASK 3
#define BLOCK_CATEGORY 7
#define BLOCK_TEST 3
#define BLOCK_TAG 1900
#define BLOCK_TAG_TO 1950
#define BLOCK_BODY_INFO BodyInfo{BLOCK_CATEGORY, BLOCK_COLLISION_MASK, BLOCK_TEST, BLOCK_TAG}
#define IS_BLOCK(tag) Range{BLOCK_TAG,BLOCK_TAG_TO}.contains(tag)
